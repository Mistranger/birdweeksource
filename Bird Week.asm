...
; ROM Start
;-------------------------------------------------------------------------------
__c000:     .hex 21 18 36 26   ; $c000: 21 18 36 26   Data
...
__c030:     jmp __f652         ; $c030: 4c 52 f6  
...
__mainMenuLoop:     
            ...
            jsr __cb2b         ; $c07a: 20 2b cb  
            jmp __cb66         ; $c07d: 4c 66 cb  

;-------------------------------------------------------------------------------
__gameLoadingLoop:     jmp ___gameLoadingLoop         ; $c080: 4c 5b c1  

;-------------------------------------------------------------------------------
__c083:     jmp __e27c         ; $c083: 4c 7c e2  
...
__c09d:     jsr __fdb6         ; $c09d: 20 b6 fd  
            jsr __c0d0         ; $c0a0: 20 d0 c0  
            jmp __enableNMI         ; $c0a3: 4c c6 fe  

;-------------------------------------------------------------------------------
__c0a6:     jsr __c22c         ; $c0a6: 20 2c c2  
...
__c0d0:     lda $5e            ; $c0d0: a5 5e     
            ...
            jsr __isBonusLevel         ; $c0d9: 20 5e c3  
            cpx #$03           ; $c0dc: e0 03     
...
__c122:     jsr __f6dd         ; $c122: 20 dd f6  
            jmp __ff3b         ; $c125: 4c 3b ff  

;-------------------------------------------------------------------------------
__c128:     
			lda vPlayMainMenuMusic          ; $c128: ad 73 02  
            ...
            jsr __isBonusLevel         ; $c145: 20 5e c3  
            inx                ; $c148: e8        
            stx $20            ; $c149: 86 20     
__c14b:     rts                ; $c14b: 60        
...
__initGameLoading:     
            ...
            and #$03           ; $c175: 29 03     
            cmp #$03           ; $c177: c9 03     
            beq __c1b0         ; $c179: f0 35     
            ldx #$00           ; $c17b: a2 00     
            stx $d3            ; $c17d: 86 d3     
            jsr __c1d4         ; $c17f: 20 d4 c1  
__c182:     lda __c221,x       ; $c182: bd 21 c2  
            sta $2007          ; $c185: 8d 07 20  
            inx                ; $c188: e8        
            cpx #$08           ; $c189: e0 08     
            bne __c182         ; $c18b: d0 f5     
            ldx #$03           ; $c18d: a2 03     
__c18f:     lda $f1,x          ; $c18f: b5 f1     
            bne __c1a3         ; $c191: d0 10     
            lda #$24           ; $c193: a9 24     
            sta $2007          ; $c195: 8d 07 20  
            dex                ; $c198: ca        
            bne __c18f         ; $c199: d0 f4     
__c19b:     inc vIsGameLoading            ; $c19b: e6 f6     
            jsr __fdb6         ; $c19d: 20 b6 fd  
            jmp __enableNMI         ; $c1a0: 4c c6 fe  

;-------------------------------------------------------------------------------
__c1a3:     lda $f1,x          ; $c1a3: b5 f1     
            sta $2007          ; $c1a5: 8d 07 20  
            dex                ; $c1a8: ca        
...
;-------------------------------------------------------------------------------
__c1b0:     jsr __d716         ; $c1b0: 20 16 d7  
            jsr __c1d4         ; $c1b3: 20 d4 c1  
__c1b6:     lda __ca3e,x       ; $c1b6: bd 3e ca  
            sta $2007          ; $c1b9: 8d 07 20  
            inx                ; $c1bc: e8        
            cpx #$06           ; $c1bd: e0 06     
            bne __c1b6         ; $c1bf: d0 f5     
__c1c1:     lda __c221,y       ; $c1c1: b9 21 c2  
            sta $2007          ; $c1c4: 8d 07 20  
            iny                ; $c1c7: c8        
            cpy #$05           ; $c1c8: c0 05     
            bne __c1c1         ; $c1ca: d0 f5     
            inc vIsGameLoading            ; $c1cc: e6 f6     
            jsr __fdb6         ; $c1ce: 20 b6 fd  
            jmp __enableNMI         ; $c1d1: 4c c6 fe  

;-------------------------------------------------------------------------------
__c1d4:     lda #$20           ; $c1d4: a9 20     
            sta ppuAddress          ; $c1d6: 8d 06 20  
            lda #$ca           ; $c1d9: a9 ca     
            sta ppuAddress          ; $c1db: 8d 06 20  
            rts                ; $c1de: 60        

;-------------------------------------------------------------------------------
__c1df:     jsr __isBonusLevel         ; $c1df: 20 5e c3  
            cpx #$03           ; $c1e2: e0 03     
...
;-------------------------------------------------------------------------------
__c21e:     sta $10,x          ; $c21e: 95 10     
            rts                ; $c220: 60        

;-------------------------------------------------------------------------------
__c221:     .hex 1b 18 1e 17   ; $c221: 1b 18 1e 17   Data
            .hex 0d 24 24 24   ; $c225: 0d 24 24 24   Data
__c229:     .hex dd df db      ; $c229: dd df db      Data

;-------------------------------------------------------------------------------
__c22c:     lda vCycleCounter            ; $c22c: a5 09     
            and #$07           ; $c22e: 29 07     
            bne __c247         ; $c230: d0 15     
...
;-------------------------------------------------------------------------------
__c23d:     lda $d0            ; $c23d: a5 d0     
            bne __c247         ; $c23f: d0 06     
            inc $d1            ; $c241: e6 d1     
            lda #$01           ; $c243: a9 01     
            sta $d0            ; $c245: 85 d0     
__c247:     rts                ; $c247: 60        
...
;-------------------------------------------------------------------------------
__c248:     lda $d1            ; $c248: a5 d1     
            and #$01           ; $c24a: 29 01     
            bne __c283         ; $c24c: d0 35     
            lda $6f            ; $c24e: a5 6f     
            bne __c275         ; $c250: d0 23     
            inc $6f            ; $c252: e6 6f     
            jsr __c29f         ; $c254: 20 9f c2  
            lda vGameState            ; $c257: a5 50     
            cmp #$fc           ; $c259: c9 fc     
            beq __c26e         ; $c25b: f0 11     
            jsr __d716         ; $c25d: 20 16 d7  
            lda #$f0           ; $c260: a9 f0     
...
;-------------------------------------------------------------------------------
__c283:     lda $6f            ; $c283: a5 6f     
            beq __c291         ; $c285: f0 0a     
            lda #$00           ; $c287: a9 00     
            sta $6f            ; $c289: 85 6f     
...
;-------------------------------------------------------------------------------
__c2b6:     jsr __isBonusLevel         ; $c2b6: 20 5e c3  
            cpx #$03           ; $c2b9: e0 03     
            ...
            ldx #$00           ; $c2c3: a2 00     
__c2c5:     lda $8c,x          ; $c2c5: b5 8c     
            cmp $65            ; $c2c7: c5 65     
            beq __c2ce         ; $c2c9: f0 03     
            inc $0205,x        ; $c2cb: fe 05 02  
...
__c2db:     lda $0205,x        ; $c2db: bd 05 02  
            cmp #$ff           ; $c2de: c9 ff     
...
__c31f:     lda #$21           ; $c31f: a9 21     
            ...
            lda $8c            ; $c325: a5 8c     
            cmp $65            ; $c327: c5 65     
            beq __c345         ; $c329: f0 1a     
            lda __c364,x       ; $c32b: bd 64 c3  
            sta $54            ; $c32e: 85 54     
            jmp __c36d         ; $c330: 4c 6d c3  

;-------------------------------------------------------------------------------
__c333:     iny                ; $c333: c8        
            lda $8d            ; $c334: a5 8d     
            cmp $65            ; $c336: c5 65     
            beq __c345         ; $c338: f0 0b     
            jsr __isBonusLevel         ; $c33a: 20 5e c3  
            lda __c367,x       ; $c33d: bd 67 c3  
            sta $54            ; $c340: 85 54     
            jsr __c36d         ; $c342: 20 6d c3  
__c345:     rts                ; $c345: 60        

;-------------------------------------------------------------------------------
__c346:     lda vCurrentLevel            ; $c346: a5 55     
            cmp #$10           ; $c348: c9 10     
            bcc __c345         ; $c34a: 90 f9     
            iny                ; $c34c: c8        
            lda $8e            ; $c34d: a5 8e     
            cmp $65            ; $c34f: c5 65     
            beq __c345         ; $c351: f0 f2     
            jsr __isBonusLevel         ; $c353: 20 5e c3  
            lda __c36a,x       ; $c356: bd 6a c3  
            sta $54            ; $c359: 85 54     
            jmp __c36d         ; $c35b: 4c 6d c3  

;-------------------------------------------------------------------------------
; writes 11 to X if current level is bonus level (every 4th level)
__isBonusLevel:     
...
;-------------------------------------------------------------------------------
__c36d:     jsr __c404         ; $c36d: 20 04 c4  
            lda $0205,y        ; $c370: b9 05 02  
            cmp #$40           ; $c373: c9 40     
...
__c385:     jsr __d08b         ; $c385: 20 8b d0  
__c388:     lda __c3b9,x       ; $c388: bd b9 c3  
            sta $2007          ; $c38b: 8d 07 20  
            lda __c3bf,x       ; $c38e: bd bf c3  
            sta $2007          ; $c391: 8d 07 20  
            jsr __c40f         ; $c394: 20 0f c4  
            lda __c3c5,x       ; $c397: bd c5 c3  
            sta $2007          ; $c39a: 8d 07 20  
            lda __c3cb,x       ; $c39d: bd cb c3  
            sta $2007          ; $c3a0: 8d 07 20  
            rts                ; $c3a3: 60        

;-------------------------------------------------------------------------------
__c3a4:     jsr __d093         ; $c3a4: 20 93 d0  
...
__c485:     inx                ; $c485: e8        
            ...
            jsr __isBonusLevel         ; $c496: 20 5e c3  
            cpx #$03           ; $c499: e0 03     
...
__c4f2:     lda $9a            ; $c4f2: a5 9a     
            ldx $0210          ; $c4f4: ae 10 02  
            bne __c4ff         ; $c4f7: d0 06     
            jsr __d716         ; $c4f9: 20 16 d7  
...
__c530:     lda $70,x          ; $c530: b5 70     
            ...
            lda #$01           ; $c540: a9 01     
            sta $0210,y        ; $c542: 99 10 02  
__c545:     lda #$03           ; $c545: a9 03     
            sta $2a            ; $c547: 85 2a     
__c549:     jmp __c57f         ; $c549: 4c 7f c5  

;-------------------------------------------------------------------------------
__c54c:     jsr __d716         ; $c54c: 20 16 d7  
__c54f:     lda $78,x          ; $c54f: b5 78     
            sec                ; $c551: 38        
            sbc #$04           ; $c552: e9 04     
            cmp $7a            ; $c554: c5 7a     
...
;-------------------------------------------------------------------------------
__c60a:     lda vPlayMainMenuMusic          ; $c60a: ad 73 02  
...
;-------------------------------------------------------------------------------
__c69c:     jsr __c6a2         ; $c69c: 20 a2 c6  
            jmp __f467         ; $c69f: 4c 67 f4  

;-------------------------------------------------------------------------------
__c6a2:     lda #$00           ; $c6a2: a9 00     
            sta $02            ; $c6a4: 85 02     
            sta $03            ; $c6a6: 85 03     
            rts                ; $c6a8: 60        

;-------------------------------------------------------------------------------
__c6a9:     lda $20            ; $c6a9: a5 20     
...
;-------------------------------------------------------------------------------
__c6b7:     jsr __isBonusLevel         ; $c6b7: 20 5e c3  
            lda $8c            ; $c6ba: a5 8c     
            cmp $64            ; $c6bc: c5 64     
...
;-------------------------------------------------------------------------------
__c70c:     jsr __c6a2         ; $c70c: 20 a2 c6  
...
__c776:     lda #$00           ; $c776: a9 00     
            ...
            sta $eb            ; $c7a3: 85 eb     
__c7a5:     tax                ; $c7a5: aa        
__c7a6:     sta $0210,x        ; $c7a6: 9d 10 02  
...
;-------------------------------------------------------------------------------
__c7e7:     jsr __isBonusLevel         ; $c7e7: 20 5e c3  
            lda $8c            ; $c7ea: a5 8c     
            cmp $64            ; $c7ec: c5 64     
...
__c826:     inc $e8            ; $c826: e6 e8     
            ...
            cmp #$b0           ; $c830: c9 b0     
            bcc __c839         ; $c832: 90 05     
            bcs __c83c         ; $c834: b0 06     
__c836:     jmp __d08b         ; $c836: 4c 8b d0  

;-------------------------------------------------------------------------------
__c839:     jmp __d093         ; $c839: 4c 93 d0  

;-------------------------------------------------------------------------------
__c83c:     jsr __d093         ; $c83c: 20 93 d0  
__c83f:     txa                ; $c83f: 8a        
            clc                ; $c840: 18        
            adc #$04           ; $c841: 69 04     
            tax                ; $c843: aa        
...
;-------------------------------------------------------------------------------
__c845:     jsr __isBonusLevel         ; $c845: 20 5e c3  
...
;-------------------------------------------------------------------------------
__c8ab:     jsr __c6a2         ; $c8ab: 20 a2 c6  
            cpy #$03           ; $c8ae: c0 03     
...
__c96f:     lda $8b            ; $c96f: a5 8b     
            ...
            jsr __ca4a         ; $c97f: 20 4a ca  
            jsr __fdb6         ; $c982: 20 b6 fd  
            dec $8b            ; $c985: c6 8b     
            lda #$0f           ; $c987: a9 0f     
            sta $20            ; $c989: 85 20     
...
__c9ad:     lda #$21           ; $c9ad: a9 21     
            ...
            ldx #$00           ; $c9b7: a2 00     
__c9b9:     lda __c9c5,x       ; $c9b9: bd c5 c9  
            sta $2007          ; $c9bc: 8d 07 20  
            inx                ; $c9bf: e8        
            cpx #$06           ; $c9c0: e0 06     
...
;-------------------------------------------------------------------------------
__c9c5:     .hex 10 18 18 0d   ; $c9c5: 10 18 18 0d   Data
...
__c9cb:     lda #$21           ; $c9cb: a9 21     
            ...
            ldx #$00           ; $c9d5: a2 00     
__c9d7:     lda __ca36,x       ; $c9d7: bd 36 ca  
            sta $2007          ; $c9da: 8d 07 20  
            inx                ; $c9dd: e8        
            cpx #$08           ; $c9de: e0 08     
            bne __c9d7         ; $c9e0: d0 f5     
            jmp __fdb6         ; $c9e2: 4c b6 fd  
...
__c9eb:     jsr __ff1a         ; $c9eb: 20 1a ff  
            ...
            ldx #$00           ; $c9f8: a2 00     
__c9fa:     lda __ca3e,x       ; $c9fa: bd 3e ca  
            sta $2007          ; $c9fd: 8d 07 20  
            inx                ; $ca00: e8        
            cpx #$0c           ; $ca01: e0 0c     
            ...
            lda #$03           ; $ca0f: a9 03     
__ca11:     sta $2007          ; $ca11: 8d 07 20  
            lda #$00           ; $ca14: a9 00     
            sta $2007          ; $ca16: 8d 07 20  
            sta $2007          ; $ca19: 8d 07 20  
            sta $2007          ; $ca1c: 8d 07 20  
            lda #$0f           ; $ca1f: a9 0f     
            sta $20            ; $ca21: 85 20     
            jsr __ca4a         ; $ca23: 20 4a ca  
            jsr __fdb6         ; $ca26: 20 b6 fd  
...
__ca6d:     lda $0100,x        ; $ca6d: bd 00 01  
            ...
            lda #$24           ; $ca72: a9 24     
            sta $2007          ; $ca74: 8d 07 20  
            dex                ; $ca77: ca        
            bne __ca6d         ; $ca78: d0 f3     
__ca7a:     lda #$00           ; $ca7a: a9 00     
            sta $2007          ; $ca7c: 8d 07 20  
__ca7f:     rts                ; $ca7f: 60        

;-------------------------------------------------------------------------------
__ca80:     lda $0100,x        ; $ca80: bd 00 01  
            sta $2007          ; $ca83: 8d 07 20  
            dex                ; $ca86: ca        
...
;-------------------------------------------------------------------------------
__ca91:     jsr __isBonusLevel         ; $ca91: 20 5e c3  
            cpx #$03           ; $ca94: e0 03     
...
__caa4:     lda __ca8c,x       ; $caa4: bd 8c ca  
            ...
            jmp __ca6b         ; $cab9: 4c 6b ca  

;-------------------------------------------------------------------------------
__cabc:     lda vPlayMainMenuMusic          ; $cabc: ad 73 02  
            bne __caf4         ; $cabf: d0 33     
            lda $0230          ; $cac1: ad 30 02  
            bne __cad6         ; $cac4: d0 10     
            lda $0104          ; $cac6: ad 04 01  
            cmp #$03           ; $cac9: c9 03     
            bcc __cad6         ; $cacb: 90 09     
            inc $0230          ; $cacd: ee 30 02  
...
__cb2b:     
			...
			lda vMainMemuCounter            ; $cb2b: a5 57     
            cmp #$20           ; $cb2d: c9 20     
            ...
            and #$01           ; $cb45: 29 01     
            bne __cb5b         ; $cb47: d0 12     
__cb49:     lda __cc35,x       ; $cb49: bd 35 cc  
            sta $2007          ; $cb4c: 8d 07 20  
            inx                ; $cb4f: e8        
            iny                ; $cb50: c8        
            cpy #$03           ; $cb51: c0 03     
            bne __cb49         ; $cb53: d0 f4     
            jsr __fdb6         ; $cb55: 20 b6 fd  
            jmp __setPPUIncrementBy1         ; $cb58: 4c da fe  

;-------------------------------------------------------------------------------
__cb5b:     ldx #$03           ; $cb5b: a2 03     
            jmp __cb49         ; $cb5d: 4c 49 cb  

;-------------------------------------------------------------------------------
__cb60:     jmp __cbcf         ; $cb60: 4c cf cb  

;-------------------------------------------------------------------------------
__cb63:     jmp __cbea         ; $cb63: 4c ea cb  

;-------------------------------------------------------------------------------
__cb66:     lda vMainMemuCounter            ; $cb66: a5 57     
            cmp #$20           ; $cb68: c9 20     
            beq __cb60         ; $cb6a: f0 f4     
            bcs __cb63         ; $cb6c: b0 f5     
            jsr __c22c         ; $cb6e: 20 2c c2  
            lda $d1            ; $cb71: a5 d1     
            and #$01           ; $cb73: 29 01     
...
__cb85:     lda #$01           ; $cb85: a9 01     
            ...
            lda #$00           ; $cb93: a9 00     
            sta $a7            ; $cb95: 85 a7     
            sta vPlayMainMenuMusic          ; $cb97: 8d 73 02  
            jsr __fdb6         ; $cb9a: 20 b6 fd  
            jsr __f596         ; $cb9d: 20 96 f5  
            inc vGameState            ; $cba0: e6 50     
            jmp __ff3b         ; $cba2: 4c 3b ff  
...
__cbaa:     lda vCycleCounter            ; $cbaa: a5 09     
            ...
            lda vMainMemuCounter            ; $cbb0: a5 57     
            cmp #$08           ; $cbb2: c9 08     
            beq __cbbb         ; $cbb4: f0 05     
__cbb6:     inc vMainMemuCounter            ; $cbb6: e6 57     
__cbb8:     jmp __c122         ; $cbb8: 4c 22 c1  

;-------------------------------------------------------------------------------
__cbbb:     lda #$09           ; $cbbb: a9 09     
            sta $20            ; $cbbd: 85 20     
            lda #$01           ; $cbbf: a9 01     
            sta vPlayMainMenuMusic          ; $cbc1: 8d 73 02  
...
;-------------------------------------------------------------------------------
__cbcf:     inc vMainMemuCounter            ; $cbcf: e6 57     
            jsr __c6a2         ; $cbd1: 20 a2 c6  
            lda $08            ; $cbd4: a5 08     
            and #$03           ; $cbd6: 29 03     
            tax                ; $cbd8: aa        
__cbd9:     inx                ; $cbd9: e8        
            cpx #$03           ; $cbda: e0 03     
            beq __cbd9         ; $cbdc: f0 fb     
            stx vCurrentLevel            ; $cbde: 86 55     
            lda #$01           ; $cbe0: a9 01     
            sta $f2            ; $cbe2: 85 f2     
            jsr __fe94         ; $cbe4: 20 94 fe  
            jmp __c083         ; $cbe7: 4c 83 c0  

;-------------------------------------------------------------------------------
__cbea:     lda vMainMemuCounter            ; $cbea: a5 57     
            cmp #$40           ; $cbec: c9 40     
            ...
            cmp vMainMemuCounter            ; $cbfc: c5 57     
...
__cc00:     ldx $0272          ; $cc00: ae 72 02  
            ...
            inc vMainMemuCounter            ; $cc0e: e6 57     
...
;-------------------------------------------------------------------------------
__cc2a:     lda #$f0           ; $cc2a: a9 f0     
            sta $0760          ; $cc2c: 8d 60 07  
            jsr __c6a2         ; $cc2f: 20 a2 c6  
            jmp __f467         ; $cc32: 4c 67 f4  

;-------------------------------------------------------------------------------
__cc35:     .hex 3d 24 24 24   ; $cc35: 3d 24 24 24   Data
            .hex 24 3f         ; $cc39: 24 3f         Data

;-------------------------------------------------------------------------------
__cc3b:     lda #$00           ; $cc3b: a9 00     
            sta vPlayMainMenuMusic          ; $cc3d: 8d 73 02  
            jsr __e3da         ; $cc40: 20 da e3  
            inc vStageSelectState          ; $cc43: ee e0 02  
            ldx #$00           ; $cc46: a2 00     
            stx $d3            ; $cc48: 86 d3     
            jsr __c1d4         ; $cc4a: 20 d4 c1  
__cc4d:     lda __c221,x       ; $cc4d: bd 21 c2  
            sta $2007          ; $cc50: 8d 07 20  
            inx                ; $cc53: e8        
            cpx #$08           ; $cc54: e0 08     
            bne __cc4d         ; $cc56: d0 f5     
            jsr __fdb6         ; $cc58: 20 b6 fd  
...
__cc81:     lda vPlayerInput            ; $cc81: a5 0a     
            and #$20           ; $cc83: 29 20     
            beq __cc97         ; $cc85: f0 10     
            lda vCurrentLevel            ; $cc87: a5 55     
            beq __cc97         ; $cc89: f0 0c     
            dec vCurrentLevel            ; $cc8b: c6 55     
            lda vCurrentLevel            ; $cc8d: a5 55     
            and #$03           ; $cc8f: 29 03     
            cmp #$03           ; $cc91: c9 03     
            bne __cc97         ; $cc93: d0 02     
            dec vCurrentLevel            ; $cc95: c6 55     
__cc97:     lda vCurrentLevel            ; $cc97: a5 55     
            tax                ; $cc99: aa        
            lda __cd05,x       ; $cc9a: bd 05 cd  
            sta vStageSelect10s          ; $cc9d: 8d e1 02  
            lda __ccd5,x       ; $cca0: bd d5 cc  
            ...
            sta $2007          ; $ccb3: 8d 07 20  
            lda vStageSelectOnes          ; $ccb6: ad e2 02  
            sta $2007          ; $ccb9: 8d 07 20  
            jsr __fdb6         ; $ccbc: 20 b6 fd  
...
;-------------------------------------------------------------------------------
__ccd5:     .hex 01 02 03 03   ; $ccd5: 01 02 03 03   Data
...
__cd05:     .hex 24 24 24 24   ; $cd05: 24 24 24 24   Data
...
__cd35:     lda #$00           ; $cd35: a9 00     
            ...
            lda #$30           ; $cdab: a9 30     
            sta $0700          ; $cdad: 8d 00 07  
            jsr __isBonusLevel         ; $cdb0: 20 5e c3  
            cpx #$03           ; $cdb3: e0 03     
...
__cdba:     lda vCurrentLevel            ; $cdba: a5 55     
            ...
            sta $d9            ; $cdda: 85 d9     
            lda __ceb4,y       ; $cddc: b9 b4 ce  
            sta $0205          ; $cddf: 8d 05 02  
            lda __cebc,y       ; $cde2: b9 bc ce  
            sta $0206          ; $cde5: 8d 06 02  
            lda __cec4,y       ; $cde8: b9 c4 ce  
            sta $0207          ; $cdeb: 8d 07 02  
            lda #$b0           ; $cdee: a9 b0     
            sta $78            ; $cdf0: 85 78     
            lda #$b8           ; $cdf2: a9 b8     
            sta $79            ; $cdf4: 85 79     
...
__ceac:     .hex 18 20 28 00   ; $ceac: 18 20 28 00   Data
            .hex 28 28 28 00   ; $ceb0: 28 28 28 00   Data
__ceb4:     .hex 00 08 00 00   ; $ceb4: 00 08 00 00   Data
            .hex 10 20 18 00   ; $ceb8: 10 20 18 00   Data
__cebc:     .hex 10 00 08 00   ; $cebc: 10 00 08 00   Data
            .hex 30 00 10 00   ; $cec0: 30 00 10 00   Data
__cec4:     .hex 00 20 20 00   ; $cec4: 00 20 20 00   Data
...
;-------------------------------------------------------------------------------
__cfdc:     sty $61            ; $cfdc: 84 61     
            lda #$00           ; $cfde: a9 00     
            sta $62            ; $cfe0: 85 62     
            jmp __cfb9         ; $cfe2: 4c b9 cf  

;-------------------------------------------------------------------------------
__cfe5:     sty $62            ; $cfe5: 84 62     
            lda #$00           ; $cfe7: a9 00     
            sta $61            ; $cfe9: 85 61     
            jmp __cfb9         ; $cfeb: 4c b9 cf  

;-------------------------------------------------------------------------------
__cfee:     lda vCurrentLevel            ; $cfee: a5 55     
            and #$07           ; $cff0: 29 07     
            cmp #$03           ; $cff2: c9 03     
            rts                ; $cff4: 60        
...
__cff5:     lda #$78           ; $cff5: a9 78     
            ...
            lda $0700          ; $cffa: ad 00 07  
            cmp #$1e           ; $cffd: c9 1e     
            bcc __d005         ; $cfff: 90 04     
            cmp #$ca           ; $d001: c9 ca     
            bcc __d00d         ; $d003: 90 08     
__d005:     jsr __fe94         ; $d005: 20 94 fe  
            lda #$30           ; $d008: a9 30     
            sta $0700          ; $d00a: 8d 00 07  
__d00d:     jsr __cfee         ; $d00d: 20 ee cf  
            bne __d019         ; $d010: d0 07     
            lda $61            ; $d012: a5 61     
            beq __d019         ; $d014: f0 03     
...
__d019:     lda vCycleCounter            ; $d019: a5 09     
            ...
            cmp #$02           ; $d027: c9 02     
            beq __d050         ; $d029: f0 25     
            cmp #$03           ; $d02b: c9 03     
            beq __d061         ; $d02d: f0 32     
            cmp #$04           ; $d02f: c9 04     
...
;-------------------------------------------------------------------------------
__d050:     jmp __d09b         ; $d050: 4c 9b d0  
...
;-------------------------------------------------------------------------------
__d08b:     lda vCycleCounter            ; $d08b: a5 09     
            and #$18           ; $d08d: 29 18     
            lsr                ; $d08f: 4a        
            jmp __d097         ; $d090: 4c 97 d0  

;-------------------------------------------------------------------------------
__d093:     lda vCycleCounter            ; $d093: a5 09     
            and #$0c           ; $d095: 29 0c     
__d097:     lsr                ; $d097: 4a        
            lsr                ; $d098: 4a        
            tax                ; $d099: aa        
...
;-------------------------------------------------------------------------------
__d09b:     lda $61            ; $d09b: a5 61     
            bne __d0c5         ; $d09d: d0 26     
            lda $62            ; $d09f: a5 62     
            bne __d0d3         ; $d0a1: d0 30     
            inc $0700          ; $d0a3: ee 00 07  
            inc $0700          ; $d0a6: ee 00 07  
            jsr __d08b         ; $d0a9: 20 8b d0  
            txa                ; $d0ac: 8a        
            clc                ; $d0ad: 18        
            adc #$08           ; $d0ae: 69 08     
            tax                ; $d0b0: aa        
...
;-------------------------------------------------------------------------------
__d0d3:     jsr __d65d         ; $d0d3: 20 5d d6  
            bne __d0db         ; $d0d6: d0 03     
            inc $0700          ; $d0d8: ee 00 07  
__d0db:     jsr __d093         ; $d0db: 20 93 d0  
            txa                ; $d0de: 8a        
            clc                ; $d0df: 18        
            adc #$08           ; $d0e0: 69 08     
            tax                ; $d0e2: aa        
...
;-------------------------------------------------------------------------------
__d0f4:     lda $61            ; $d0f4: a5 61     
            bne __d107         ; $d0f6: d0 0f     
            jsr __d08b         ; $d0f8: 20 8b d0  
...
;-------------------------------------------------------------------------------
__d107:     jsr __d08b         ; $d107: 20 8b d0  
            txa                ; $d10a: 8a        
            clc                ; $d10b: 18        
            adc #$10           ; $d10c: 69 10     
            tax                ; $d10e: aa        
            jsr __d084         ; $d10f: 20 84 d0  
            jsr __d65d         ; $d112: 20 5d d6  
            beq __d104         ; $d115: f0 ed     
            rts                ; $d117: 60        

;-------------------------------------------------------------------------------
__d118:     lda $61            ; $d118: a5 61     
            bne __d125         ; $d11a: d0 09     
            jsr __d08b         ; $d11c: 20 8b d0  
            jsr __d084         ; $d11f: 20 84 d0  
__d122:     jmp __d16e         ; $d122: 4c 6e d1  

;-------------------------------------------------------------------------------
__d125:     jsr __d08b         ; $d125: 20 8b d0  
            txa                ; $d128: 8a        
            clc                ; $d129: 18        
            adc #$14           ; $d12a: 69 14     
            tax                ; $d12c: aa        
            jsr __d084         ; $d12d: 20 84 d0  
            jsr __d65d         ; $d130: 20 5d d6  
            beq __d122         ; $d133: f0 ed     
            rts                ; $d135: 60        

;-------------------------------------------------------------------------------
__d136:     lda $61            ; $d136: a5 61     
...
;-------------------------------------------------------------------------------
__d16e:     inc $03            ; $d16e: e6 03     
            bne __d174         ; $d170: d0 02     
            inc $02            ; $d172: e6 02     
__d174:     lda $02            ; $d174: a5 02     
            and #$01           ; $d176: 29 01     
            sta $02            ; $d178: 85 02     
            rts                ; $d17a: 60        

;-------------------------------------------------------------------------------
__d17b:     lda $03            ; $d17b: a5 03     
            bne __d181         ; $d17d: d0 02     
            dec $02            ; $d17f: c6 02     
__d181:     dec $03            ; $d181: c6 03     
...
__d20e:     .hex 08 0c 10 0a   ; $d20e: 08 0c 10 0a   Data
...
__d2ad:     .hex 00 00 00 40   ; $d2ad: 00 00 00 40   Data
...
__d34c:     .hex 0a 0e 12 08   ; $d34c: 0a 0e 12 08   Data
...
__d3eb:     .hex 00 00 00 40   ; $d3eb: 00 00 00 40   Data
...
__d51b:     sta $6b            ; $d51b: 85 6b     
            ...
            lda $67            ; $d526: a5 67     
            bne __d53d         ; $d528: d0 13     
            lda $68            ; $d52a: a5 68     
            bne __d540         ; $d52c: d0 12     
            lda $08            ; $d52e: a5 08     
            bne __d534         ; $d530: d0 02     
            inc $68            ; $d532: e6 68     
__d534:     lda $6a            ; $d534: a5 6a     
            beq __d56e         ; $d536: f0 36     
            bne __d58e         ; $d538: d0 54     
__d53a:     jmp __d5af         ; $d53a: 4c af d5  

;-------------------------------------------------------------------------------
__d53d:     jmp __d618         ; $d53d: 4c 18 d6  

;-------------------------------------------------------------------------------
__d540:     lda $68            ; $d540: a5 68     
            cmp $69            ; $d542: c5 69     
            beq __d5a8         ; $d544: f0 62     
            inc $68            ; $d546: e6 68     
            lda $98            ; $d548: a5 98     
            cmp #$1a           ; $d54a: c9 1a     
            ...
            lda $0700          ; $d552: ad 00 07  
            cmp $98            ; $d555: c5 98     
            beq __d5a8         ; $d557: f0 4f     
...
__d56e:     inc $78            ; $d56e: e6 78     
            inc $79            ; $d570: e6 79     
            lda #$00           ; $d572: a9 00     
            sta $6a            ; $d574: 85 6a     
            jsr __d08b         ; $d576: 20 8b d0  
            lda __d667,x       ; $d579: bd 67 d6  
            sta $0725          ; $d57c: 8d 25 07  
            lda __d66b,x       ; $d57f: bd 6b d6  
            sta $0729          ; $d582: 8d 29 07  
            jmp __d630         ; $d585: 4c 30 d6  

;-------------------------------------------------------------------------------
__d588:     jsr __d64a         ; $d588: 20 4a d6  
            jmp __d55f         ; $d58b: 4c 5f d5  

;-------------------------------------------------------------------------------
__d58e:     dec $78            ; $d58e: c6 78     
            dec $79            ; $d590: c6 79     
            lda #$01           ; $d592: a9 01     
            sta $6a            ; $d594: 85 6a     
            jsr __d08b         ; $d596: 20 8b d0  
            lda __d66f,x       ; $d599: bd 6f d6  
            sta $0725          ; $d59c: 8d 25 07  
            lda __d673,x       ; $d59f: bd 73 d6  
            sta $0729          ; $d5a2: 8d 29 07  
            jmp __d630         ; $d5a5: 4c 30 d6  

;-------------------------------------------------------------------------------
__d5a8:     lda #$00           ; $d5a8: a9 00     
            sta $68            ; $d5aa: 85 68     
...
__d5b4:     lda $98            ; $d5b4: a5 98     
            cmp #$c8           ; $d5b6: c9 c8     
            bcs __d5d0         ; $d5b8: b0 16     
            jsr __d64a         ; $d5ba: 20 4a d6  
            jsr __d64a         ; $d5bd: 20 4a d6  
            jsr __d093         ; $d5c0: 20 93 d0  
...
;-------------------------------------------------------------------------------
__d618:     lda $98            ; $d618: a5 98     
            cmp #$80           ; $d61a: c9 80     
            bcc __d62c         ; $d61c: 90 0e     
            dec $98            ; $d61e: c6 98     
            dec $99            ; $d620: c6 99     
            lda $6a            ; $d622: a5 6a     
            beq __d629         ; $d624: f0 03     
            jmp __d58e         ; $d626: 4c 8e d5  

;-------------------------------------------------------------------------------
__d629:     jmp __d56e         ; $d629: 4c 6e d5  

;-------------------------------------------------------------------------------
__d62c:     lda #$00           ; $d62c: a9 00     
            sta $67            ; $d62e: 85 67     
__d630:     jsr __d662         ; $d630: 20 62 d6  
            bne __d649         ; $d633: d0 14     
            lda $98            ; $d635: a5 98     
            cmp #$20           ; $d637: c9 20     
            bcc __d649         ; $d639: 90 0e     
            cmp #$c8           ; $d63b: c9 c8     
            bcs __d649         ; $d63d: b0 0a     
            lda $08            ; $d63f: a5 08     
            and #$01           ; $d641: 29 01     
            bne __d64a         ; $d643: d0 05     
            dec $98            ; $d645: c6 98     
            dec $99            ; $d647: c6 99     
__d649:     rts                ; $d649: 60        

;-------------------------------------------------------------------------------
__d64a:     inc $98            ; $d64a: e6 98     
            inc $99            ; $d64c: e6 99     
            rts                ; $d64e: 60        
...
;-------------------------------------------------------------------------------
__d658:     lda vCycleCounter            ; $d658: a5 09     
            and #$01           ; $d65a: 29 01     
            rts                ; $d65c: 60        

;-------------------------------------------------------------------------------
__d65d:     lda vCycleCounter            ; $d65d: a5 09     
            and #$03           ; $d65f: 29 03     
            rts                ; $d661: 60        

;-------------------------------------------------------------------------------
__d662:     lda vCycleCounter            ; $d662: a5 09     
            and #$07           ; $d664: 29 07     
            rts                ; $d666: 60        

;-------------------------------------------------------------------------------
__d667:     .hex 45 47 49 47   ; $d667: 45 47 49 47   Data
__d66b:     .hex 3f 41 43 41   ; $d66b: 3f 41 43 41   Data
__d66f:     .hex 3e 40 42 40   ; $d66f: 3e 40 42 40   Data
__d673:     .hex 44 46 48 46   ; $d673: 44 46 48 46   Data
...
;-------------------------------------------------------------------------------
__d716:     ldx #$00           ; $d716: a2 00     
            ldy #$00           ; $d718: a0 00     
            rts                ; $d71a: 60        

;-------------------------------------------------------------------------------
__d71b:     jsr __c22c         ; $d71b: 20 2c c2  
...
;-------------------------------------------------------------------------------
__d762:     jsr __d716         ; $d762: 20 16 d7  
...
__d7cc:     jsr __setPPUIncrementBy32         ; $d7cc: 20 e4 fe  
            ...
            lda #$b0           ; $d7eb: a9 b0     
            sta $2007          ; $d7ed: 8d 07 20  
            lda #$b1           ; $d7f0: a9 b1     
            sta $2007          ; $d7f2: 8d 07 20  
            lda #$23           ; $d7f5: a9 23     
            ...
            lda #$b2           ; $d802: a9 b2     
            sta $2007          ; $d804: 8d 07 20  
            lda #$b3           ; $d807: a9 b3     
            sta $2007          ; $d809: 8d 07 20  
            inc $02c2          ; $d80c: ee c2 02  
            jsr __fdb6         ; $d80f: 20 b6 fd  
...
;-------------------------------------------------------------------------------
__d89e:     jsr __isBonusLevel         ; $d89e: 20 5e c3  
            cpx #$03           ; $d8a1: e0 03     
            beq __d901         ; $d8a3: f0 5c     
            ldx #$00           ; $d8a5: a2 00     
__d8a7:     lda $b3,x          ; $d8a7: b5 b3     
...
__d8c5:     sta $0200,x        ; $d8c5: 9d 00 02  
__d8c8:     inx                ; $d8c8: e8        
            cpx #$04           ; $d8c9: e0 04     
...
__d8ee:     ldx #$00           ; $d8ee: a2 00     
            ldy #$00           ; $d8f0: a0 00     
__d8f2:     lda $0200,x        ; $d8f2: bd 00 02  
...
;-------------------------------------------------------------------------------
__d922:     inc $73,x          ; $d922: f6 73     
            jmp __d918         ; $d924: 4c 18 d9  

;-------------------------------------------------------------------------------
__d927:     dec $73,x          ; $d927: d6 73     
            jmp __d91b         ; $d929: 4c 1b d9  

;-------------------------------------------------------------------------------
__d92c:     dec $93,x          ; $d92c: d6 93     
            jmp __d91e         ; $d92e: 4c 1e d9  

;-------------------------------------------------------------------------------
__d931:     inc $93,x          ; $d931: f6 93     
            rts                ; $d933: 60        
...
__d968:     lda $0205          ; $d968: ad 05 02  
            ...
            lda #$00           ; $d978: a9 00     
            sta $0205          ; $d97a: 8d 05 02  
__d97d:     sta $b3,x          ; $d97d: 95 b3     
            sta $93,x          ; $d97f: 95 93     
            lda #$05           ; $d981: a9 05     
            sta $2a            ; $d983: 85 2a     
            lda #$00           ; $d985: a9 00     
...
__d98c:     lda $0206          ; $d98c: ad 06 02  
            ...
            lda #$00           ; $d99c: a9 00     
            sta $0206          ; $d99e: 8d 06 02  
            jmp __d97d         ; $d9a1: 4c 7d d9  

;-------------------------------------------------------------------------------
__d9a4:     lda $0700          ; $d9a4: ad 00 07  
...
__d9d4:     lda $0700          ; $d9d4: ad 00 07  
__d9d7:     sta $93,x          ; $d9d7: 95 93     
            lda #$1e           ; $d9d9: a9 1e     
            jmp __d8c5         ; $d9db: 4c c5 d8  

;-------------------------------------------------------------------------------
__d9de:     lda $0207          ; $d9de: ad 07 02  
            cmp #$40           ; $d9e1: c9 40     
...
;-------------------------------------------------------------------------------
__daa1:     inc $73,x          ; $daa1: f6 73     
            jmp __da80         ; $daa3: 4c 80 da  

;-------------------------------------------------------------------------------
__daa6:     dec $73,x          ; $daa6: d6 73     
            jmp __da83         ; $daa8: 4c 83 da  

;-------------------------------------------------------------------------------
__daab:     dec $93,x          ; $daab: d6 93     
            jmp __da86         ; $daad: 4c 86 da  

;-------------------------------------------------------------------------------
__dab0:     inc $93,x          ; $dab0: f6 93     
...
__dc84:     lda vPlayerInput            ; $dc84: a5 0a     
            ...
            ldx #$00           ; $dc8a: a2 00     
__dc8c:     lda $0210,x        ; $dc8c: bd 10 02  
...
;-------------------------------------------------------------------------------
__dce5:     jsr __isBonusLevel         ; $dce5: 20 5e c3  
            cpx #$02           ; $dce8: e0 02     
...
__dd6f:     lda $9e            ; $dd6f: a5 9e     
            cmp #$a0           ; $dd71: c9 a0     
            bcs __dd79         ; $dd73: b0 04     
            lda $08            ; $dd75: a5 08     
            beq __dd91         ; $dd77: f0 18     
__dd79:     jsr __d65d         ; $dd79: 20 5d d6  
...
;-------------------------------------------------------------------------------
__dde0:     jsr __isBonusLevel         ; $dde0: 20 5e c3  
            cpx #$01           ; $dde3: e0 01     
...
;-------------------------------------------------------------------------------
__df43:     lda $90            ; $df43: a5 90     
            cmp $0700          ; $df45: cd 00 07  
...
;-------------------------------------------------------------------------------
__df69:     dec $70            ; $df69: c6 70     
            lda #$01           ; $df6b: a9 01     
            sta $0255          ; $df6d: 8d 55 02  
            rts                ; $df70: 60        

;-------------------------------------------------------------------------------
__df71:     jsr __d65d         ; $df71: 20 5d d6  
...
__dffe:     jsr __d65d         ; $dffe: 20 5d d6  
...
__e213:     lda $0110,y        ; $e213: b9 10 01  
            ...
            lda #$24           ; $e218: a9 24     
            sta $2007          ; $e21a: 8d 07 20  
            dey                ; $e21d: 88        
            bne __e213         ; $e21e: d0 f3     
__e220:     lda #$00           ; $e220: a9 00     
            sta $2007          ; $e222: 8d 07 20  
            rts                ; $e225: 60        

;-------------------------------------------------------------------------------
__e226:     lda $0110,y        ; $e226: b9 10 01  
            sta $2007          ; $e229: 8d 07 20  
            dey                ; $e22c: 88        
            bne __e226         ; $e22d: d0 f7     
            beq __e220         ; $e22f: f0 ef     
...
__e25a:     ldx #$00           ; $e25a: a2 00     
            lda #$f0           ; $e25c: a9 f0     
__e25e:     sta $0600,x        ; $e25e: 9d 00 06  
            inx                ; $e261: e8        
...
;-------------------------------------------------------------------------------
__e27c:     jsr __disableNMI         ; $e27c: 20 d0 fe  
            jsr __disableDrawing         ; $e27f: 20 ee fe  
            jsr __setPPUIncrementBy1         ; $e282: 20 da fe  
            jsr __e3aa         ; $e285: 20 aa e3  
            jsr __fe64         ; $e288: 20 64 fe  
            jsr __e4ca         ; $e28b: 20 ca e4  
            ...
            jsr __e47e         ; $e2aa: 20 7e e4  
            jsr __e44a         ; $e2ad: 20 4a e4  
            jsr __fdb6         ; $e2b0: 20 b6 fd  
...
;-------------------------------------------------------------------------------
__e3aa:     lda vCurrentLevel            ; $e3aa: a5 55     
            and #$07           ; $e3ac: 29 07     
            asl                ; $e3ae: 0a        
            tax                ; $e3af: aa        
__e3b0:     lda __e3c7,x       ; $e3b0: bd c7 e3  
            sta $53            ; $e3b3: 85 53     
            lda __e3c8,x       ; $e3b5: bd c8 e3  
            sta $54            ; $e3b8: 85 54     
            ldy #$00           ; $e3ba: a0 00     
__e3bc:     lda ($53),y        ; $e3bc: b1 53     
            sta $0030,y        ; $e3be: 99 30 00  
            iny                ; $e3c1: c8        
            cpy #$20           ; $e3c2: c0 20     
            bne __e3bc         ; $e3c4: d0 f6     
            rts                ; $e3c6: 60        
...
;-------------------------------------------------------------------------------
__e3da:     
			lda vPlayMainMenuMusic          ; $e3da: ad 73 02  
...
__e3e5:     jsr __disableNMI         ; $e3e5: 20 d0 fe  
            ...
            jsr __fe94         ; $e3eb: 20 94 fe  
            jsr __setPPUIncrementBy1         ; $e3ee: 20 da fe  
            ldx #$0a           ; $e3f1: a2 0a     
            jsr __e3b0         ; $e3f3: 20 b0 e3  
            jsr __fe64         ; $e3f6: 20 64 fe  
            jsr __e4ca         ; $e3f9: 20 ca e4  
            lda #$0a           ; $e3fc: a9 0a     
            ldx #$20           ; $e3fe: a2 20     
            ...
            lda #$f0           ; $e408: a9 f0     
            sta $0600          ; $e40a: 8d 00 06  
            inc $d3            ; $e40d: e6 d3     
            jsr __fdb6         ; $e40f: 20 b6 fd  
            jsr __ff3b         ; $e412: 20 3b ff  
            jmp __enableNMI         ; $e415: 4c c6 fe  

;-------------------------------------------------------------------------------
__e418:     lda $f2            ; $e418: a5 f2     
            cmp #$01           ; $e41a: c9 01     
...
__e43e:     sty $2007          ; $e43e: 8c 07 20  
            inx                ; $e441: e8        
            cpx #$20           ; $e442: e0 20     
            bne __e43e         ; $e444: d0 f8     
            jsr __fdb6         ; $e446: 20 b6 fd  
            rts                ; $e449: 60        
...
;-------------------------------------------------------------------------------
__e47e:     lda vCurrentLevel            ; $e47e: a5 55     
            and #$03           ; $e480: 29 03     
            cmp #$03           ; $e482: c9 03     
            beq __e4ad         ; $e484: f0 27     
            lda vCurrentLevel            ; $e486: a5 55     
            tay                ; $e488: a8        
            and #$03           ; $e489: 29 03     
            asl                ; $e48b: 0a        
            tax                ; $e48c: aa        
            lda __e4ba,x       ; $e48d: bd ba e4  
            sta ppuAddress          ; $e490: 8d 06 20  
            inx                ; $e493: e8        
            lda __e4ba,x       ; $e494: bd ba e4  
            sta ppuAddress          ; $e497: 8d 06 20  
            ldx #$00           ; $e49a: a2 00     
            lda vCurrentLevel            ; $e49c: a5 55     
            cmp #$10           ; $e49e: c9 10     
            bcs __e4ae         ; $e4a0: b0 0c     
__e4a2:     lda __e4c0,x       ; $e4a2: bd c0 e4  
            sta $2007          ; $e4a5: 8d 07 20  
            inx                ; $e4a8: e8        
            cpx #$04           ; $e4a9: e0 04     
            bne __e4a2         ; $e4ab: d0 f5     
__e4ad:     rts                ; $e4ad: 60        

;-------------------------------------------------------------------------------
__e4ae:     lda __e4c4,x       ; $e4ae: bd c4 e4  
            sta $2007          ; $e4b1: 8d 07 20  
            inx                ; $e4b4: e8        
            cpx #$06           ; $e4b5: e0 06     
            bne __e4ae         ; $e4b7: d0 f5     
            rts                ; $e4b9: 60        

;-------------------------------------------------------------------------------
__e4ba:     .hex 22 10 21 d8   ; $e4ba: 22 10 21 d8   Data
            .hex 21 c8         ; $e4be: 21 c8         Data
__e4c0:     .hex 75 7c 7c 77   ; $e4c0: 75 7c 7c 77   Data
__e4c4:     .hex 75 7c 7c 7c   ; $e4c4: 75 7c 7c 7c   Data
            .hex 7c 77         ; $e4c8: 7c 77         Data

;-------------------------------------------------------------------------------
__e4ca:     lda #$20           ; $e4ca: a9 20     
            sta ppuAddress          ; $e4cc: 8d 06 20  
            lda #$64           ; $e4cf: a9 64     
            sta ppuAddress          ; $e4d1: 8d 06 20  
            ldx #$00           ; $e4d4: a2 00     
            lda #$24           ; $e4d6: a9 24     
__e4d8:     sta $2007          ; $e4d8: 8d 07 20  
            inx                ; $e4db: e8        
            cpx #$14           ; $e4dc: e0 14     
            bne __e4d8         ; $e4de: d0 f8     
            rts                ; $e4e0: 60        
...
__ee98:     lda vCycleCounter            ; $ee98: a5 09     
            ...
            sta $89            ; $ee9c: 85 89     
            inc $89            ; $ee9e: e6 89     
            jsr __isBonusLevel         ; $eea0: 20 5e c3  
...
__ef12:     lda vStageSelect10s          ; $ef12: ad e1 02  
            ...
            jsr __d65d         ; $ef21: 20 5d d6  
            bne __ef28         ; $ef24: d0 02     
            inc $7f            ; $ef26: e6 7f     
__ef28:     jsr __d08b         ; $ef28: 20 8b d0  
            lda __ef61,x       ; $ef2b: bd 61 ef  
            jmp __eeb8         ; $ef2e: 4c b8 ee  

;-------------------------------------------------------------------------------
__ef31:     jsr __d65d         ; $ef31: 20 5d d6  
...
__ef3b:     lda $89            ; $ef3b: a5 89     
            ...
            jsr __d65d         ; $ef41: 20 5d d6  
            bne __ef48         ; $ef44: d0 02     
            inc $7f            ; $ef46: e6 7f     
__ef48:     jsr __d08b         ; $ef48: 20 8b d0  
            lda __ef65,x       ; $ef4b: bd 65 ef  
            jmp __eeb8         ; $ef4e: 4c b8 ee  

;-------------------------------------------------------------------------------
__ef51:     jsr __d65d         ; $ef51: 20 5d d6  
...
__ef69:     lda $bf            ; $ef69: a5 bf     
            ...
            lda vPlayMainMenuMusic          ; $ef71: ad 73 02  
...
;-------------------------------------------------------------------------------
__efb7:     jsr __d658         ; $efb7: 20 58 d6  
...
__f005:     lda vCurrentLevel            ; $f005: a5 55     
            ...
            lda $c6            ; $f023: a5 c6     
            and #$c0           ; $f025: 29 c0     
            bne __f04d         ; $f027: d0 24     
            lda $0700          ; $f029: ad 00 07  
            cmp $a0            ; $f02c: c5 a0     
            bcc __f04d         ; $f02e: 90 1d     
            lda $17            ; $f030: a5 17     
            cmp #$05           ; $f032: c9 05     
            bne __f04d         ; $f034: d0 17     
            lda #$00           ; $f036: a9 00     
            sta $c6            ; $f038: 85 c6     
            lda $80            ; $f03a: a5 80     
...
;-------------------------------------------------------------------------------
__f0bd:     inc $a0            ; $f0bd: e6 a0     
            inc $a0            ; $f0bf: e6 a0     
            lda #$96           ; $f0c1: a9 96     
            jmp __f065         ; $f0c3: 4c 65 f0  

;-------------------------------------------------------------------------------
__f0c6:     lda $c6            ; $f0c6: a5 c6     
            ora #$08           ; $f0c8: 09 08     
            and #$09           ; $f0ca: 29 09     
            sta $c6            ; $f0cc: 85 c6     
            rts                ; $f0ce: 60        
...
;-------------------------------------------------------------------------------
__f10d:     jsr __isBonusLevel         ; $f10d: 20 5e c3  
            cpx #$03           ; $f110: e0 03     
...
;-------------------------------------------------------------------------------
__f147:     jsr __d658         ; $f147: 20 58 d6  
...
;-------------------------------------------------------------------------------
__f19d:     jsr __isBonusLevel         ; $f19d: 20 5e c3  
            cpx #$03           ; $f1a0: e0 03     
...
__f22f:     lda $a6            ; $f22f: a5 a6     
            ...
            lda #$12           ; $f237: a9 12     
            sta $20            ; $f239: 85 20     
__f23b:     jsr __d65d         ; $f23b: 20 5d d6  
...
;-------------------------------------------------------------------------------
__f2dc:     jsr __d093         ; $f2dc: 20 93 d0  
...
__f3d3:     jsr __d093         ; $f3d3: 20 93 d0  
...
__f484:     lda __f4a9,x       ; $f484: bd a9 f4  
            sta $2007          ; $f487: 8d 07 20  
            inx                ; $f48a: e8        
            cpx #$09           ; $f48b: e0 09     
            bne __f484         ; $f48d: d0 f5     
...
;-------------------------------------------------------------------------------
__f4a9:     .hex 10 0a 16 0e   ; $f4a9: 10 0a 16 0e   Data
            .hex 24 18 1a 0e   ; $f4ad: 24 18 1a 0e   Data
            .hex 1b            ; $f4b1: 1b            Data

;-------------------------------------------------------------------------------
__f4b2:     jsr __d08b         ; $f4b2: 20 8b d0  
            lda __f542,x       ; $f4b5: bd 42 f5  
            sta $0739          ; $f4b8: 8d 39 07  
            jsr __d658         ; $f4bb: 20 58 d6  
...
__f526:     sta $7d            ; $f526: 85 7d     
            ...
            sta $0205,y        ; $f536: 99 05 02  
__f539:     inc $e9            ; $f539: e6 e9     
            lda #$0a           ; $f53b: a9 0a     
            sta $20            ; $f53d: 85 20     
...
__f549:     lda #$00           ; $f549: a9 00     
            ...
            tax                ; $f55a: aa        
__f55b:     sta $53,x          ; $f55b: 95 53     
            sta $0200,x        ; $f55d: 9d 00 02  
            inx                ; $f560: e8        
            cpx #$ad           ; $f561: e0 ad     
            bne __f55b         ; $f563: d0 f6     
            inc vGameState            ; $f565: e6 50     
            jsr __fe94         ; $f567: 20 94 fe  
...
__f5bb:     jsr __disableDrawing         ; $f5bb: 20 ee fe  
            ...
            sta $20            ; $f5c2: 85 20     
            tax                ; $f5c4: aa        
__f5c5:     lda __c000,x       ; $f5c5: bd 00 c0  
            sta $30,x          ; $f5c8: 95 30     
            inx                ; $f5ca: e8        
            cpx #$20           ; $f5cb: e0 20     
            bne __f5c5         ; $f5cd: d0 f6     
            jsr __fe64         ; $f5cf: 20 64 fe  
            lda #$20           ; $f5d2: a9 20     
...
__f5e8:     lda vCurrentLevel            ; $f5e8: a5 55     
            ...
            stx $2005          ; $f5f7: 8e 05 20  
            stx $2005          ; $f5fa: 8e 05 20  
__f5fd:     nop                ; $f5fd: ea        
            dex                ; $f5fe: ca        
...
__f608:     dex                ; $f608: ca        
            ...
            jmp __fdb6         ; $f60d: 4c b6 fd  

;-------------------------------------------------------------------------------
__f610:     lda #$f0           ; $f610: a9 f0     
            sta $0600          ; $f612: 8d 00 06  
            jmp __fdb6         ; $f615: 4c b6 fd  
...
__f618:     lda #$fc           ; $f618: a9 fc     
            ...
            lda #$17           ; $f622: a9 17     
            sta $0600          ; $f624: 8d 00 06  
            lda #$20           ; $f627: a9 20     
            sta $0602          ; $f629: 8d 02 06  
            rts                ; $f62c: 60        

;-------------------------------------------------------------------------------
__f62d:     jsr __isBonusLevel         ; $f62d: 20 5e c3  
            cpx #$03           ; $f630: e0 03     
...
__f73e:     lda $26            ; $f73e: a5 26     
            ...
            sta $4002,x        ; $f747: 9d 02 40  
            lda __f7fa,y       ; $f74a: b9 fa f7  
            ora $24            ; $f74d: 05 24     
            sta $4003,x        ; $f74f: 9d 03 40  
__f752:     jsr __f78c         ; $f752: 20 8c f7  
            lda $26            ; $f755: a5 26     
            and #$20           ; $f757: 29 20     
            bne __f760         ; $f759: d0 05     
            jmp __f71b         ; $f75b: 4c 1b f7  

;-------------------------------------------------------------------------------
__f75e:     sty $20            ; $f75e: 84 20     
__f760:     rts                ; $f760: 60        
...
__f83a:     lda #$0f           ; $f83a: a9 0f     
            sta $4015          ; $f83c: 8d 15 40  
            lda #$c0           ; $f83f: a9 c0     
            sta $4017          ; $f841: 8d 17 40  
            lda #$0f           ; $f844: a9 0f     
            sta $4000          ; $f846: 8d 00 40  
            sta $4004          ; $f849: 8d 04 40  
            sta $4008          ; $f84c: 8d 08 40  
            lda #$7f           ; $f84f: a9 7f     
            sta $4001          ; $f851: 8d 01 40  
            sta $4005          ; $f854: 8d 05 40  
            rts                ; $f857: 60        
...
__secondVBlank:     
            ...
            lda #$20           ; $fd4d: a9 20     
            jsr __fe13         ; $fd4f: 20 13 fe  
            jsr __ffea         ; $fd52: 20 ea ff  
__fd55:     lda __c020         ; $fd55: ad 20 c0  
            sta __c020         ; $fd58: 8d 20 c0  
            jsr __fda3         ; $fd5b: 20 a3 fd  
            beq __fd55         ; $fd5e: f0 f5     
__fd60:     lda __c021         ; $fd60: ad 21 c0  
            sta __c021         ; $fd63: 8d 21 c0  
            jsr __fda3         ; $fd66: 20 a3 fd  
            bne __fd60         ; $fd69: d0 f5     
            lda #$b0           ; $fd6b: a9 b0     
...
__fd7f:     inc $08            ; $fd7f: e6 08     
            inc $08            ; $fd81: e6 08     
            inc $17            ; $fd83: e6 17     
            inc $08            ; $fd85: e6 08     
            jmp __fd7f         ; $fd87: 4c 7f fd  
...
;-------------------------------------------------------------------------------
__fda3:     lda #$1f           ; $fda3: a9 1f     
            sta ppuAddress          ; $fda5: 8d 06 20  
            lda #$f0           ; $fda8: a9 f0     
            sta ppuAddress          ; $fdaa: 8d 06 20  
            lda $2007          ; $fdad: ad 07 20  
            lda $2007          ; $fdb0: ad 07 20  
            cmp #$0c           ; $fdb3: c9 0c     
            rts                ; $fdb5: 60        

;-------------------------------------------------------------------------------
__fdb6:     lda vPPUController            ; $fdb6: a5 06     
            and #$fc           ; $fdb8: 29 fc     
            tax                ; $fdba: aa        
            lda $02            ; $fdbb: a5 02     
...
__fdc6:     stx vPPUController            ; $fdc6: 86 06     
            ...
            lda $03            ; $fdcb: a5 03     
            sta $2005          ; $fdcd: 8d 05 20  
            lda $05            ; $fdd0: a5 05     
            sta $2005          ; $fdd2: 8d 05 20  
            rts                ; $fdd5: 60        
...
__fdea:     ldx #$00           ; $fdea: a2 00     
            lda #$f0           ; $fdec: a9 f0     
__fdee:     sta $0700,x        ; $fdee: 9d 00 07  
            inx                ; $fdf1: e8        
            bne __fdee         ; $fdf2: d0 fa     
            rts                ; $fdf4: 60        

;-------------------------------------------------------------------------------
__fdf5:     sta ppuAddress          ; $fdf5: 8d 06 20  
            ldx #$00           ; $fdf8: a2 00     
            stx ppuAddress          ; $fdfa: 8e 06 20  
            ldy #$03           ; $fdfd: a0 03     
            lda #$24           ; $fdff: a9 24     
__fe01:     sta $2007          ; $fe01: 8d 07 20  
            inx                ; $fe04: e8        
            bne __fe01         ; $fe05: d0 fa     
            dey                ; $fe07: 88        
            bne __fe01         ; $fe08: d0 f7     
__fe0a:     sta $2007          ; $fe0a: 8d 07 20  
            inx                ; $fe0d: e8        
            cpx #$c0           ; $fe0e: e0 c0     
...
__fe13:     clc                ; $fe13: 18        
            ...
            lda #$00           ; $fe1e: a9 00     
            tax                ; $fe20: aa        
__fe21:     sta $2007          ; $fe21: 8d 07 20  
            inx                ; $fe24: e8        
            cpx #$40           ; $fe25: e0 40     
            bne __fe21         ; $fe27: d0 f8     
            rts                ; $fe29: 60        
...
;-------------------------------------------------------------------------------
__fe64:     ldy #$3f           ; $fe64: a0 3f     
            sty ppuAddress          ; $fe66: 8c 06 20  
            ldx #$00           ; $fe69: a2 00     
            stx ppuAddress          ; $fe6b: 8e 06 20  
__fe6e:     lda $30,x          ; $fe6e: b5 30     
            sta $2007          ; $fe70: 8d 07 20  
            inx                ; $fe73: e8        
            cpx #$20           ; $fe74: e0 20     
            bne __fe6e         ; $fe76: d0 f6     
...
;-------------------------------------------------------------------------------
__fe87:     ldx #$00           ; $fe87: a2 00     
__fe89:     lda __c000,x       ; $fe89: bd 00 c0  
            sta $30,x          ; $fe8c: 95 30     
            inx                ; $fe8e: e8        
            cpx #$20           ; $fe8f: e0 20     
            bne __fe89         ; $fe91: d0 f6     
            rts                ; $fe93: 60        

;-------------------------------------------------------------------------------
__fe94:     ldx #$00           ; $fe94: a2 00     
            lda #$f0           ; $fe96: a9 f0     
__fe98:     sta $0700,x        ; $fe98: 9d 00 07  
            inx                ; $fe9b: e8        
            inx                ; $fe9c: e8        
            inx                ; $fe9d: e8        
            inx                ; $fe9e: e8        
            bne __fe98         ; $fe9f: d0 f7     
            rts                ; $fea1: 60        

;-------------------------------------------------------------------------------
__fea2:     ldx #$01           ; $fea2: a2 01     
            stx $4016          ; $fea4: 8e 16 40  
            lda #$00           ; $fea7: a9 00     
            sta $4016          ; $fea9: 8d 16 40  
            ldx #$08           ; $feac: a2 08     
__feae:     lda $4016          ; $feae: ad 16 40  
            and #$03           ; $feb1: 29 03     
            cmp #$01           ; $feb3: c9 01     
            ror vPlayerInput            ; $feb5: 66 0a     
            lda $4017          ; $feb7: ad 17 40  
            and #$03           ; $feba: 29 03     
            cmp #$01           ; $febc: c9 01     
            ror $0b            ; $febe: 66 0b     
            dex                ; $fec0: ca        
            bne __feae         ; $fec1: d0 eb     
...
;-------------------------------------------------------------------------------
__ff3b:     ldy #$00           ; $ff3b: a0 00     
            lda vCycleCounter            ; $ff3d: a5 09     
            and #$01           ; $ff3f: 29 01     
            bne __ff46         ; $ff41: d0 03     
            jmp __ff98         ; $ff43: 4c 98 ff  

;-------------------------------------------------------------------------------
__ff46:     lda $0700,y        ; $ff46: b9 00 07  
            clc                ; $ff49: 18        
            adc #$ff           ; $ff4a: 69 ff     
            sta $0604,y        ; $ff4c: 99 04 06  
            ldx $0701,y        ; $ff4f: be 01 07  
            lda __d34c,x       ; $ff52: bd 4c d3  
            sta $0605,y        ; $ff55: 99 05 06  
            lda __d3eb,x       ; $ff58: bd eb d3  
            sta $0606,y        ; $ff5b: 99 06 06  
            lda $0703,y        ; $ff5e: b9 03 07  
            clc                ; $ff61: 18        
            adc #$08           ; $ff62: 69 08     
            sta $0607,y        ; $ff64: 99 07 06  
            iny                ; $ff67: c8        
            iny                ; $ff68: c8        
            iny                ; $ff69: c8        
            iny                ; $ff6a: c8        
            cpy #$7c           ; $ff6b: c0 7c     
            bne __ff46         ; $ff6d: d0 d7     
            ldy #$80           ; $ff6f: a0 80     
__ff71:     lda $0680,y        ; $ff71: b9 80 06  
            clc                ; $ff74: 18        
            adc #$ff           ; $ff75: 69 ff     
            sta $0604,y        ; $ff77: 99 04 06  
            ldx $0681,y        ; $ff7a: be 81 06  
            lda __d20e,x       ; $ff7d: bd 0e d2  
            sta $0605,y        ; $ff80: 99 05 06  
            lda __d2ad,x       ; $ff83: bd ad d2  
            sta $0606,y        ; $ff86: 99 06 06  
            lda $0683,y        ; $ff89: b9 83 06  
            sta $0607,y        ; $ff8c: 99 07 06  
            iny                ; $ff8f: c8        
            iny                ; $ff90: c8        
            iny                ; $ff91: c8        
            iny                ; $ff92: c8        
            cpy #$fc           ; $ff93: c0 fc     
            bne __ff71         ; $ff95: d0 da     
            rts                ; $ff97: 60        

;-------------------------------------------------------------------------------
__ff98:     lda $0700,y        ; $ff98: b9 00 07  
            clc                ; $ff9b: 18        
            adc #$ff           ; $ff9c: 69 ff     
            sta $0604,y        ; $ff9e: 99 04 06  
            ldx $0701,y        ; $ffa1: be 01 07  
            lda __d20e,x       ; $ffa4: bd 0e d2  
            sta $0605,y        ; $ffa7: 99 05 06  
            lda __d2ad,x       ; $ffaa: bd ad d2  
            sta $0606,y        ; $ffad: 99 06 06  
            lda $0703,y        ; $ffb0: b9 03 07  
            sta $0607,y        ; $ffb3: 99 07 06  
            iny                ; $ffb6: c8        
            iny                ; $ffb7: c8        
            iny                ; $ffb8: c8        
            iny                ; $ffb9: c8        
            cpy #$7c           ; $ffba: c0 7c     
            bne __ff98         ; $ffbc: d0 da     
            ldy #$80           ; $ffbe: a0 80     
__ffc0:     lda $0680,y        ; $ffc0: b9 80 06  
            clc                ; $ffc3: 18        
            adc #$ff           ; $ffc4: 69 ff     
            sta $0604,y        ; $ffc6: 99 04 06  
            ldx $0681,y        ; $ffc9: be 81 06  
            lda __d34c,x       ; $ffcc: bd 4c d3  
            sta $0605,y        ; $ffcf: 99 05 06  
            lda __d3eb,x       ; $ffd2: bd eb d3  
            sta $0606,y        ; $ffd5: 99 06 06  
            lda $0683,y        ; $ffd8: b9 83 06  
            clc                ; $ffdb: 18        
            adc #$08           ; $ffdc: 69 08     
            sta $0607,y        ; $ffde: 99 07 06  
            iny                ; $ffe1: c8        
            iny                ; $ffe2: c8        
            iny                ; $ffe3: c8        
            iny                ; $ffe4: c8        
            cpy #$fc           ; $ffe5: c0 fc     
            bne __ffc0         ; $ffe7: d0 d7     
            rts                ; $ffe9: 60        
