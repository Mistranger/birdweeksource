...
__c1b6:     lda __bonusLabel,x       ; $c1b6: bd 3e ca  
...
;-------------------------------------------------------------------------------
__c283:     lda vIsGamePaused            ; $c283: a5 6f     
...
__d62c:     lda #$00           ; $d62c: a9 00     
            sta $67            ; $d62e: 85 67     
__d630:     jsr __getCycleModulo8         ; $d630: 20 62 d6  
